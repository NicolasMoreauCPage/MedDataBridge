...
| Anomalies Ruff sur `app/` | 339 | dette de qualité non bloquante en CI |
...
- **BE-07 :** les familles Ruff bloquantes `F821`, `F823`, `F601` et `F811`
  ...
  des 339 alertes restantes (principalement imports, imports tardifs et
  ...
  produisaient. Les constructions de mappings restants sont maintenant
