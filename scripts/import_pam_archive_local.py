#!/usr/bin/env python3
"""Import all HL7 messages from local pam_archive directory."""
import asyncio
import os
...
ARCHIVE_DIR = Path("/home/nico/Travail/Fhir_MedBridgeData/MedData_Bridge/pam_archive")


async def import_archive():
    """Import all HL7 files from pam_archive directory."""
