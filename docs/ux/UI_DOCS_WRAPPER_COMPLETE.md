...
**Fonctionnalités**:
- ✅ Intercepte toutes les requêtes `/docs/*`
...
```bash
✅ /docs/PROGRAM_DOCUMENTATION.html       → header + main ✓
✅ /docs/architecture.html                → header + main ✓
✅ /docs/FHIR_API.html                   → header + main ✓
✅ /docs/models_reference.html            → header + main ✓
✅ /docs/user_guide.html                 → header + main ✓
✅ /docs/IHE_PAM_INTEGRATION_COMPLETE_FR.html → header + main ✓
✅ /docs/IHE_PAM_WORKFLOWS_FR.html       → header + main ✓
