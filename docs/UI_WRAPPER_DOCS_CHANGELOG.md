...
- Routeur FastAPI qui intercepte les requêtes `/Doc/{file_path:path}`
...
### Avant
- `/Doc/user_guide.html` → Fichier HTML brut sans bandeau ni menu
- Styles génériques du fichier HTML original
- Pas de navigation cohérente

### Après ✅
- `/Doc/user_guide.html` → Enveloppé dans base.html
