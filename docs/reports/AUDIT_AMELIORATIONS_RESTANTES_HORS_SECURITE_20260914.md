...
| Anomalies Ruff sur `app/` | 433 | dette de qualité non bloquante en CI |
...
- **BE-07 :** les familles Ruff bloquantes `F821`, `F823`, `F601` et `F811`
  ...
  des 433 alertes restantes (principalement imports, imports tardifs et
  variables inutilisées) demeure un chantier distinct ; aucun correctif global
  automatique n'a été appliqué. La CI impose aussi une baseline globale à 433
