...
class Patient(SQLModel, table=True):
    ...
    birth_date: Optional[date] = None  # Date de naissance
    ...
    identity_reliability_date: Optional[date] = None  # Date de validation de l'identité
    ...
    ins_last_query_date: Optional[date] = None  # Date dernier appel service INSI - RNIV
