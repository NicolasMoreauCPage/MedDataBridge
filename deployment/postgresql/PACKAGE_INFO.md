...
Le répertoire `deployment/` contient **TOUT** ce qui est nécessaire pour déployer MedData Bridge sur un serveur Fedora 7.9 **SANS connexion Internet** avec Python 3.8.
...
- [ ] Package `deployment/` prêt (31 MB, 423 fichiers)
...
Le package `deployment/` est **complet et prêt à être déployé** sur un serveur Fedora 7.9 sans connexion Internet.
