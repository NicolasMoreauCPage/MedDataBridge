...
# MedData Bridge - Configuration Production
...
[Unit]
Description=MedData Bridge - Healthcare Interoperability Platform
...
echo "   sudo -u postgres createdb meddata_bridge"
echo "   sudo -u postgres createuser meddata"
echo ""
echo "2. Configurer l'application:"
echo "   cd ${INSTALL_DIR}/config"
echo "   cp .env.example .env"
echo "   vi .env  # Éditer les paramètres"
echo ""
