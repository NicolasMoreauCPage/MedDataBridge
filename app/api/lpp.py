...
def create_lpp_act(act: LPPActCreate, session: Session = Depends(get_session)):
    """
...
def get_lpp_act(act_id: int, session: Session = Depends(get_session)):
    """
...
def list_lpp_acts_by_dossier(dossier_id: int, session: Session = Depends(get_session)):
    """
...
def update_lpp_act(
    act_id: int, act: LPPActUpdate, session: Session = Depends(get_session)
):
...
def delete_lpp_act(act_id: int, session: Session = Depends(get_session)):
...
def validate_lpp_act(act_id: int, session: Session = Depends(get_session)):
    """
