...
| Anomalies Ruff sur `app/` | 371 | dette de qualité non bloquante en CI |
...
- **BE-07 :** les familles Ruff bloquantes `F821`, `F823`, `F601` et `F811`
  ...
  des 371 alertes restantes (principalement imports, imports tardifs et
  ...
  anomalies : toute nouvelle alerte échoue désormais avant fusion. Le lot le
  plus récent a supprimé 27 variables locales inutilisées, sans supprimer les
  validations hiérarchiques qui les produisaient.
