...
def main():
    ...
    base_path = Path("/home/nico/Travail/Fhir_MedBridgeData/MedData_Bridge/docs/interfaces.integration_src/interfaces.integration/target/classes/data/entrant/hl7")
