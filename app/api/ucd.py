...
def create_ucd_act(act: UCDActCreate, session: Session = Depends(get_session)):
    """
...
def get_ucd_act(act_id: int, session: Session = Depends(get_session)):
    """
...
def list_ucd_acts_by_dossier(dossier_id: int, session: Session = Depends(get_session)):
    """
...
def update_ucd_act(
    act_id: int, act: UCDActUpdate, session: Session = Depends(get_session)
):
...
def delete_ucd_act(act_id: int, session: Session = Depends(get_session)):
...
def validate_ucd_act(act_id: int, session: Session = Depends(get_session)):
    """
