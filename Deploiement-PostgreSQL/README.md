...
Ce script va télécharger tous les packages Python (wheels + sources) dans `Deploiement/dependencies/`.
...
cd /opt/meddata-bridge
sudo -u meddata ./venv/bin/pip install --no-index --find-links=/tmp/Deploiement/dependencies --upgrade -r /tmp/Deploiement/requirements-production.txt

# Copier les nouveaux fichiers
sudo rsync -av /tmp/Deploiement/app/ /opt/meddata-bridge/app/
sudo rsync -av /tmp/Deploiement/alembic/ /opt/meddata-bridge/alembic/
