...
Ce document décrit les corrections nécessaires pour amener MedDataBridge en conformité avec les spécifications IHE PAM France (CPage + extension nationale) tout en séparant clairement la documentation externe (`/docs/`) de la documentation interne (répertoire `/docs/Technical/`).
...
- IHE PAM FR CPage v2.11 (PDF) -> `/docs/SpecIHEPAM_CPage/...`
- IHE PAM Extension Nationale v2.11.1 -> `/docs/SpecIHEPAM/...`
